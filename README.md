...
## Deploy and run
Check out the project.  Then create a file called .env in the root directory. You must have a variable called OPEN_AI_KEY here.  If you have no money on this key,
analysis won't work but the app otherwise runs.
...
The front end does not use ssl.  Though there is a workaround for running locally, my
understanding is that I'd have to packe ngix and do some more config to make this work with docker.
